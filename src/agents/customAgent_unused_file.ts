...
export default defineAgent({
    entry: async (ctx: JobContext) => {
        ...
        const systemPrompt: string = metadata.prompt ?? 'You are a helpful AI assistant.';
        ...
        await ctx.room.localParticipant?.publishData(new TextEncoder().encode(helloMessage), {
            reliable: true,
