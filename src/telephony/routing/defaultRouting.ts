  ...
  async resolveRouting(ctx: CallRoutingContext): Promise<CallRoutingResult> {
    ...
    return {
      agentConfig: {
        ...
        prompt:
          "You are a helpful voice AI assistant on a phone call. Be concise, speak in short sentences, and confirm important details. If you didn't hear something clearly, ask the caller to repeat.",
