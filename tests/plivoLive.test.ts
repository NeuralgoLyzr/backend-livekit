...
import { PlivoClient, isPlivoClientError } from '../src/telephony/adapters/plivo/plivoClient.js';
...
describe.skipIf(!AUTH_ID || !AUTH_TOKEN)('PlivoClient (live)', () => {
    ...
    describe('origination URI lifecycle', () => {
        it('create origination URI → list confirms → delete uri', { timeout: 30_000 }, async () => {
    ...
    describe('error handling', () => {
        it('getPhoneNumber with invalid id throws', { timeout: 30_000 }, async () => {
            try {
